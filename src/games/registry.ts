...
<ul>
  ...
  <li>בסרגל למעלה בוחרים מה לחיצה עושה: <b>⛏️ חשיפה</b> או <b>🚩 דגל</b>.</li>
  <li><b>קיצורי דרך למי שרוצה</b> (אף פעם לא חובה):
      <b>לחיצה ימנית</b> על תא מסתיר או מוריד דגל בלי להחליף מצב;
      ולחיצה על <b>מספר שכל המוקשים שלו כבר מסומנים</b> פותחת בבת אחת את כל
      השכנים הנותרים.</li>
